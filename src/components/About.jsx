      ...
      <div className="slides overflow-hidden sticky top-0 left-0 flex gap-20 w-full h-[100vh]">
        <div className="slide w-full flex items-center justify-center h-screen flex-shrink-0">
          <div class="text font-[PP_Neue_Machina_Inktrap_Medium]">
            <h1 class="text-8xl ">Curious how it all started?</h1>
          </div>
          <div class="image absolute top-1/2 rounded-full overflow-hidden -translate-y-1/2 right-[-10%] w-[22rem] h-[22rem]">
            <img
        ...
        <div className="slide w-full flex items-center justify-center h-screen flex-shrink-0">
          <div class="absolute top-[10%] left-[15%]">
            <h1 class="text-5xl ">From friends to founders, <br /> our journey began with a spark.</h1>
          </div>
          <div class="image absolute top-[10%] right-0 rounded-full overflow-hidden -translate-y-1/2 right-[-10%] w-[22rem] h-[22rem]">
            <img
              class="w-full h-full object-cover "
          ...
          <div class="absolute bottom-[15%] right-[15%]">
            <h1 class="text-5xl ">Youthiapa started as merch, <br /> but became a movement.</h1>
          </div>
          <div class="image absolute bottom-[-5%] left-[15%] rounded-full overflow-hidden -translate-y-1/2 right-[-10%] w-[12rem] h-[12rem]">
            <img
              class="w-full h-full object-cover "
        ...
        <div className="slide w-full flex items-center justify-center h-screen flex-shrink-0">
          <div class="absolute top-[5%] left-[15%] w-[18vw]">
            <h1 class="text-xl ">We wanted more than trends—we wanted purpose.</h1>
          </div>
          ...
          <div class="absolute bottom-[55%] right-[15%]">
            <h1 class="text-5xl ">That’s how Raised Right was born.</h1>
          </div>
